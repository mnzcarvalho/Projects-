...
public class GameManager {
    ...
    private static final int PLAYER_BASE_DAMAGE = 50000;
    ...
    public GameManager() {
        ...
        // 🔥 CONECTE O INVENTORY AO PLAYER
        this.player.setInventory(this.playerInventory); // Você precisará criar este método setter
    ...
    // 🔥 ADICIONE ESTE MÉTODO AO GameManager.java
    ...
    public StashSystem getStashSystem() { return stashSystem; }
